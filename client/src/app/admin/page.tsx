  ...
  return (
    <div className="bg-gray-50 min-h-screen px-6 py-10">
      ...
      <h1 className="text-3xl font-bold text-center text-blue-700 mb-10 flex items-center justify-center gap-2">
        <FaCogs className="text-blue-700" /> Admin Dashboard Panel
      </h1>
      ...
      {/* Admin Info Section */}
      <div className="max-w-5xl mx-auto bg-white p-8 rounded-xl shadow border border-blue-100">
        <h3 className="text-2xl font-semibold text-blue-700 mb-4 flex items-center gap-2">
          <FaCogs className="text-blue-700" /> Admin Controls & Capabilities
        </h3>
